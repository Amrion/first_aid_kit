...
const InputsRegForm: FC = () => {
    ...
    const [submitName, setSubmitName] = useState<boolean>(true);
    const [errorName, setErrorName] = useState<string>('');
    const [valueName, setValueName] = useState<string>('');
    const [classErrorName, setClassErrorName] = useState<string>('');

    const [submitSurName, setSubmitSurName] = useState<boolean>(true);
    ...
    const [submitEmail, setSubmitEmail] = useState<boolean>(true);
    const [errorEmail, setErrorEmail] = useState<string>('');
    const [valueEmail, setValueEmail] = useState<string>('');
    const [classErrorEmail, setClassErrorEmail] = useState<string>('');

    const [submitAge, setSubmitAge] = useState<boolean>(true);
    ...
    const [submitPass, setSubmitPass] = useState<boolean>(true);
    ...
    const submit = async (e) => {
        ...
        if (!submitSurName) {
            setErrorSurName('Введите действительную фамилию');
            setClassErrorSurName('error-active');
            setSubmitSurName(false)
